...
- [ ] **ACCIÓN REQUERIDA**: Añadir el secret `CURSEFORGE_API_KEY` en GitHub → Settings → Secrets → Actions → New repository secret, con el valor `$2a$10$wIJoeapbxkZ1tE8h2S/ojOLkDwqdEjAq9ZXqAUwFKlRUcZYx5iLsO`
