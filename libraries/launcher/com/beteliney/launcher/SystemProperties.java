package com.beteliney.launcher;

import com.beteliney.launcher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        // Beteliney Launcher properties
        if (name != null)
            System.setProperty("com.beteliney.launcher.instance.name", name);
        if (iconId != null)
            System.setProperty("com.beteliney.launcher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("com.beteliney.launcher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("com.beteliney.launcher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("com.beteliney.launcher.window.dimensions", windowDimensions);

        // Compat: org.prismlauncher.* (mods que lean estas props siguen funcionando)
        if (name != null)
