...
#define BETELINEY_EXTERNAL_EXE
#include "FileSystem.h"

#include "GitHubRelease.h"

class BetelineyUpdaterApp : public QApplication {
    // friends for the purpose of limiting access to deprecated stuff
    Q_OBJECT
   public:
    enum Status { Starting, Failed, Succeeded, Initialized, Aborted };
    BetelineyUpdaterApp(int& argc, char** argv);
    virtual ~BetelineyUpdaterApp();
   ...
   private:
    ...
    bool loadBetelineyVersionFromExe(const QString& exe_path);
   ...
   private:
    ...
    QString m_betelineyExecutable;
    QUrl m_betelineyRepoUrl;
    ...
    QString m_betelineyBinaryName;
    QString m_betelineyVersion;
    int m_betelineyVersionMajor = -1;
    int m_betelineyVersionMinor = -1;
    int m_betelineyVersionPatch = -1;
    QString m_betelineyVersionChannel;
    QString m_betelineyGitCommit;
