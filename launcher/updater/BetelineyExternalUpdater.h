...
class BetelineyExternalUpdater : public ExternalUpdater {
    Q_OBJECT

   public:
    BetelineyExternalUpdater(QWidget* parent, const QString& appDir, const QString& dataDir);
    ~BetelineyExternalUpdater() override;
