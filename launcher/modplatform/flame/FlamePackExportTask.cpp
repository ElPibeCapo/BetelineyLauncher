...
void FlamePackExportTask::collectFiles()
{
    ...
    m_files.clear();
    if (!BetelineyZip::collectFileListRecursively(m_options.instance->gameRoot(), nullptr, &m_files, m_options.filter)) {
...
void FlamePackExportTask::buildZip()
{
    ...
    auto zipTask = makeShared<BetelineyZip::ExportToZipTask>(m_options.output, m_gameRoot, m_files, "overrides/", true);
