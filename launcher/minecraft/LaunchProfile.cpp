...
{
    // LaunchProfile itself has no problems - problems are tracked per-Component.
    // The VersionPage aggregates component problems by calling getProblems() on each patch.
    return {};
}
