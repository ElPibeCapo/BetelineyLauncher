...
LaunchTask* MinecraftInstance::createLaunchTask(AuthSessionPtr session, MinecraftTarget::Ptr targetToJoin)
{
    ...
    // load meta - siempre online para que cuentas No-Premium también descarguen archivos
    {
    ...
    // ClaimAccount solo para cuentas Premium
    if (session->launchMode != LaunchMode::Offline) {
        process->appendStep(makeShared<ClaimAccount>(pptr, session));
    }
    // Siempre descargar librerías, incluso para cuentas No-Premium
