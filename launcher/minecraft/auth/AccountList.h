 ...
 * This should be loaded in the background by Beteliney Launcher on startup.
 */
class AccountList : public QAbstractListModel {
   ...
   signals:
    ...
    void saveFailure(const QString& reason);  // emitted when account list fails to save to disk
