...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by Beteliney Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: Beteliney Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// Beteliney Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED Beteliney Launcher extension - display name
    QString m_displayname;

    /**
     * Beteliney Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in Beteliney Launcher, but could be elsewhere
     * Beteliney Launcher specific, because of FTB.
     */
