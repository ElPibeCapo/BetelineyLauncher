...
IconType BetelineyIcon::type() const
{
    return m_current_type;
}

QString BetelineyIcon::name() const
{
    if (m_name.size())
        return m_name;
    return m_key;
...
bool BetelineyIcon::has(IconType _type) const
{
    return m_images[_type].present();
}

QIcon BetelineyIcon::icon() const
{
...
void BetelineyIcon::remove(IconType rm_type)
{
...
void BetelineyIcon::replace(IconType new_type, QIcon icon, QString path)
{
...
void BetelineyIcon::replace(IconType new_type, const QString& key)
{
    if (new_type > m_current_type || m_current_type == IconType::ToBeDeleted) {
        m_current_type = new_type;
    }
...
QString BetelineyIcon::getFilePath() const
{
    if (m_current_type == IconType::ToBeDeleted) {
        return QString();
    }
...
bool BetelineyIcon::isBuiltIn() const
{
