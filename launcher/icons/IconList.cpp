...
void IconList::sortIconList()
{
    ...
    std::sort(m_icons.begin(), m_icons.end(), [](const BetelineyIcon& a, const BetelineyIcon& b) {
...
void IconList::directoryChanged(const QString& path)
{
    ...
    for (const BetelineyIcon& it : m_icons) {
...
const BetelineyIcon* IconList::icon(const QString& key) const
{
