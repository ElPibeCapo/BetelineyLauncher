...
QVariant InstanceList::data(const QModelIndex& index, int role) const
{
    ...
    switch (role) {
        ...
        // El grupo vacío se trata como "sin grupo" — la vista lo filtra. Ver InstanceView.h.
        case GroupRole: {
...
class InstanceStaging : public Task {
   ...
   public:
    ...
    bool abort() override
    {
        ...
        // Detener el timer de backoff si está corriendo (esperando para reintentar el commit)
    ...
    {
        // Se puede abortar si la tarea hija lo permite, O si estamos en backoff (esperando reintento)
        return m_backoffTimer.isActive() || (m_child && m_child->canAbort());
    }
