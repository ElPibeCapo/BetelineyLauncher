...
void InstanceImportTask::processZipPack()
{
    ...
    BetelineyZip::ArchiveReader packZip(m_archivePath);
    ...
    auto detectInstance = [this, &extractDir, &root](BetelineyZip::ArchiveReader::File* f, bool& stop) {
        if (!isRunning()) {
            stop = true;
            return true;
        }
    ...
    auto zipTask = makeShared<BetelineyZip::ExtractZipTask>(m_archivePath, extractDir, root);
