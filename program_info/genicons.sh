...
LAUNCHER_APPID="com.beteliney.BetelineyLauncher"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/beteliney_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/beteliney_"*".png"

    rm -f beteliney.ico && icotool -o beteliney.ico -c \
        "$d/beteliney_256.png"  \
        "$d/beteliney_128.png"  \
        "$d/beteliney_64.png"   \
        "$d/beteliney_48.png"   \
